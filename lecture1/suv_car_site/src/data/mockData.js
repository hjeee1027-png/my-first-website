...
export const CARS = [
  ...
  },
  {
    id: 5,
    car_id: 'VTG-2025-005',
    model_name: 'VANTAGE Meridian X',
    model_name_ko: '반티지 메리디안 X',
    brand: 'VANTAGE',
    year: 2025,
    fuel_type: '하이브리드',
    base_price: 198000000,
    discount_rate: 0.0,
    is_promotion: false,
    efficiency: 13.8,
    max_power: '290kW',
    thumbnail_url: `${B}img/car2_thumb.webp`,
    images: [`${B}img/car2_1.webp`, `${B}img/car2_2.webp`, `${B}img/car2_3.webp`, `${B}img/car2_4.webp`],
    color_options: ['abyss_black', 'desert_gold', 'titanium_silver', 'pacific_blue'],
    description: '완벽한 균형. 메리디안 X는 V6 하이브리드 파워트레인과 풀타임 AWD 시스템으로 어떤 환경에서도 최상의 드라이빙 경험을 선사합니다.',
    highlights: ['V6 하이브리드 AWD', '에어 서스펜션 표준', '22인치 다이아몬드 컷 휠', '16스피커 오디오', '후석 마사지 시트'],
    badge: null,
  },
  {
    id: 6,
    car_id: 'VTG-2024-006',
    model_name: 'VANTAGE Horizon SE',
    model_name_ko: '반티지 호라이즌 SE',
    brand: 'VANTAGE',
    year: 2024,
    fuel_type: '디젤',
    base_price: 148000000,
    discount_rate: 0.08,
    is_promotion: true,
    efficiency: 15.1,
    max_power: '220kW',
    thumbnail_url: `${B}img/car3_thumb.jpeg`,
    images: [`${B}img/car3_1.webp`, `${B}img/car3_2.webp`, `${B}img/car3_3.webp`, `${B}img/car3_4.jpeg`],
    color_options: ['serenity_white', 'graphite_grey', 'titanium_silver', 'abyss_black'],
    description: '합리적인 선택의 기준. 호라이즌 SE는 2.2L 디젤 엔진의 강력한 토크와 뛰어난 연비로 장거리 여행에 최적화되었습니다.',
    highlights: ['2.2L 디젤 AWD', '7인승 풀플랫 2열', '스마트 어라운드뷰', '원격 주차 제어', 'HUD 표준'],
    badge: '할인특가',
  },
  {
    id: 7,
    car_id: 'VTG-2025-007',
    model_name: 'VANTAGE Zenith EV Pro',
    model_name_ko: '반티지 제니스 EV 프로',
    brand: 'VANTAGE',
    year: 2025,
    fuel_type: '전기',
    ...
    max_power: '380kW',
    thumbnail_url: `${B}img/car4_thumb.webp`,
    images: [`${B}img/car4_1.webp`, `${B}img/car4_2.webp`, `${B}img/car4_3.jpeg`, `${B}img/car4_4.jpeg`],
    color_options: ['abyss_black', 'serenity_white', 'pacific_blue', 'desert_gold'],
    description: '전기의 미래, 성능의 정수. 제니스 EV 프로는 듀얼 모터 AWD와 800V 초급속 충전으로 전기 SUV의 새로운 기준을 세웁니다.',
    highlights: ['듀얼모터 AWD 514kW', '1회 충전 600km', '800V 초급속 충전 10분 100km', 'GT 스포츠 모드', '반자율주행 Level 3'],
    badge: '신규 출시',
  },
  {
    id: 8,
    car_id: 'VTG-2024-008',
    model_name: 'VANTAGE Atlas III',
    model_name_ko: '반티지 아틀라스 III',
    brand: 'VANTAGE',
    year: 2024,
    fuel_type: '가솔린',
    ...
    max_power: '185kW',
    thumbnail_url: `${B}img/car1_thumb.jpeg`,
    images: [`${B}img/car1_1.jpeg`, `${B}img/car1_2.jpeg`, `${B}img/car1_3.jpeg`, `${B}img/car1_4.jpeg`],
    color_options: ['serenity_white', 'abyss_black', 'graphite_grey', 'desert_gold'],
    description: '도심과 자연을 잇는 브리지. 아틀라스 III는 2.0L 터보 가솔린과 8단 자동변속기의 완벽한 조합으로 도심 주행과 오프로드 모두 자신 있습니다.',
    highlights: ['2.0L 터보 AWD', '오프로드 드라이브 모드', '스마트 견인 어시스트', '10.25인치 클러스터', '선루프'],
    badge: '특가',
  },
  {
    id: 9,
    car_id: 'VTG-2025-009',
    model_name: 'VANTAGE Solaris VII',
    model_name_ko: '반티지 솔라리스 VII',
    brand: 'VANTAGE',
    year: 2025,
    fuel_type: '하이브리드',
    base_price: 260000000,
    discount_rate: 0.0,
    is_promotion: false,
    efficiency: 11.9,
    max_power: '350kW',
    thumbnail_url: `${B}img/car1_thumb.jpeg`,
    images: [`${B}img/car1_1.jpeg`, `${B}img/car1_2.jpeg`, `${B}img/car1_3.jpeg`, `${B}img/car1_4.jpeg`],
    color_options: ['abyss_black', 'desert_gold', 'serenity_white', 'pacific_blue'],
    description: '최고급 럭셔리의 완성. 솔라리스 VII은 탁월한 정숙성, 최상위 소재, 그리고 첨단 기술이 융합된 반티지의 플래그십 모델입니다.',
    highlights: ['플래그십 V8 하이브리드', '나파 가죽 + 원목 인테리어', '23인치 단조 알로이 휠', '4D 마사지 시트', 'Level 3 자율주행'],
    badge: '플래그십',
  },
  {
    id: 10,
    car_id: 'VTG-2024-010',
    model_name: 'VANTAGE Forge S',
    model_name_ko: '반티지 포지 S',
    brand: 'VANTAGE',
    year: 2024,
    fuel_type: '디젤',
    base_price: 89000000,
    ...
    thumbnail_url: `${B}img/car2_thumb.webp`,
    images: [`${B}img/car2_1.webp`, `${B}img/car2_2.webp`, `${B}img/car2_3.webp`, `${B}img/car2_4.webp`],
    color_options: ['graphite_grey', 'serenity_white', 'abyss_black', 'titanium_silver'],
    description: '실용성과 경제성의 극대화. 포지 S는 1.6L 디젤의 최고 연비와 넉넉한 실내 공간으로 가족 여행과 비즈니스 모두 완벽하게 소화합니다.',
    highlights: ['1.6L 디젤 16km/L', '7인승 넉넉한 실내', '전방충돌 방지 어시스트', '오토 에어컨 3존', '무선 애플 카플레이'],
    badge: '최고 연비',
  },
  {
    id: 11,
    car_id: 'VTG-2025-011',
    model_name: 'VANTAGE Eclipse GT',
    model_name_ko: '반티지 이클립스 GT',
    brand: 'VANTAGE',
    year: 2025,
    fuel_type: '가솔린',
    base_price: 175000000,
    discount_rate: 0.04,
    is_promotion: false,
    efficiency: 11.2,
    max_power: '310kW',
    thumbnail_url: `${B}img/car3_thumb.jpeg`,
    images: [`${B}img/car3_1.webp`, `${B}img/car3_2.webp`, `${B}img/car3_3.webp`, `${B}img/car3_4.jpeg`],
    color_options: ['abyss_black', 'pacific_blue', 'graphite_grey', 'desert_gold'],
    description: '스포츠 SUV의 새 지평. 이클립스 GT는 3.5L V6 트윈터보로 제로백 4.9초를 달성하면서도 SUV 특유의 실용성을 그대로 유지합니다.',
    highlights: ['3.5L V6 트윈터보', '0-100km/h 4.9초', '스포츠 에어 서스펜션', '카본파이버 외장 패키지', '브렘보 브레이크'],
    badge: '스포츠',
  },
  {
    id: 12,
    car_id: 'VTG-2025-012',
    model_name: 'VANTAGE Nova EV',
    model_name_ko: '반티지 노바 EV',
    brand: 'VANTAGE',
    year: 2025,
    fuel_type: '전기',
    base_price: 72000000,
    ...
    thumbnail_url: `${B}img/car4_thumb.webp`,
    images: [`${B}img/car4_1.webp`, `${B}img/car4_2.webp`, `${B}img/car4_3.jpeg`, `${B}img/car4_4.jpeg`],
    color_options: ['serenity_white', 'pacific_blue', 'desert_gold', 'graphite_grey'],
    description: '전기차 입문의 완벽한 파트너. 노바 EV는 합리적인 가격에 400km 이상의 주행거리와 다양한 첨단 안전 기능을 담았습니다.',
    highlights: ['1회 충전 420km', '급속 충전 50분', 'V2L 외부 전원', '스마트 에너지 회생', '레인지 부스터 모드'],
    badge: null,
  },
  {
    id: 13,
    car_id: 'VTG-2024-013',
    model_name: 'VANTAGE Colossus 4x4',
    model_name_ko: '반티지 콜로서스 4x4',
    brand: 'VANTAGE',
    year: 2024,
    fuel_type: '디젤',
    ...
    thumbnail_url: `${B}img/car2_thumb.webp`,
    images: [`${B}img/car2_1.webp`, `${B}img/car2_2.webp`, `${B}img/car2_3.webp`, `${B}img/car2_4.webp`],
    color_options: ['abyss_black', 'graphite_grey', 'desert_gold', 'serenity_white'],
    description: '정통 오프로더의 혼. 콜로서스 4x4는 3.0L V6 디젤과 로우레인지 기어박스, 전자식 디퍼렌셜로 극한의 오프로드도 거뜬히 주파합니다.',
    highlights: ['로우레인지 기어박스', '전자식 리미티드 슬립 디퍼렌셜', '지형 선택 시스템 6종', '방수 언더바디 코팅', '루프 탑 텐트 지원 루프랙'],
    badge: '오프로드',
  },
  {
    id: 14,
    car_id: 'VTG-2025-014',
    model_name: 'VANTAGE Prism Hybrid',
    model_name_ko: '반티지 프리즘 하이브리드',
    brand: 'VANTAGE',
    year: 2025,
    fuel_type: '하이브리드',
    base_price: 128000000,
    discount_rate: 0.03,
    is_promotion: false,
    efficiency: 16.5,
    max_power: '215kW',
    thumbnail_url: `${B}img/car3_thumb.jpeg`,
    images: [`${B}img/car3_1.webp`, `${B}img/car3_2.webp`, `${B}img/car3_3.webp`, `${B}img/car3_4.jpeg`],
    color_options: ['serenity_white', 'pacific_blue', 'titanium_silver', 'abyss_black'],
    description: '친환경과 퍼포먼스의 완벽한 균형. 프리즘 하이브리드는 1.6L 하이브리드 시스템으로 준대형 SUV 최고 연비를 달성했습니다.',
    highlights: ['1.6L 하이브리드 AWD', '준대형 최고 연비 16.5km/L', '전기 전용 주행 50km', '12.3인치 듀얼 스크린', '차선 유지 어시스트'],
    badge: null,
  },
]
